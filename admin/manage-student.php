...
if(isset($_POST['importSubmit'])){
    ...
    $response = mysqli_query($conn, $find_student) or die(mysqli_error($conn));
                ...
                header('Location: ./students.php?query=manage');
                    ...
                    $password = sha1($password);
                    $add_student1= "INSERT INTO students (name,email,class_id,gender,phone,dob,address,password) VALUES ('$name','$email','$class_id','$gender','$phone','$dob','$address','$password') ";
                    $response = mysqli_query($conn, $add_student1) or die(mysqli_error($conn));
                    header('Location: admin.php');
                }
            }
